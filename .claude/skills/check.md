---
name: check
description: Run all quality checks (lint, format, test, build, cspell) across the monorepo. Use when the user says "check", "run all checks", "CI checks", "verify everything", or wants a full quality gate before committing or pushing.
---
