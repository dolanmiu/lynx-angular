...
```
packages/
  rsbuild-plugin-ng-lynx/   # @blotch/rsbuild-plugin-ng-lynx — RSpeedy build plugin for Angular+Lynx
    src/
      pluginNgLynx.ts        # Main entry: CSS, entry, layers, rules, generation
