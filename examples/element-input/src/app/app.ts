...
@Component({
  ...
  template: `
    <scroll-view class="page" scroll-orientation="vertical">
      <view class="container">
        ...
        <text class="subtitle">
          Text input with reactive signal binding.
        </text>
  ...
  styles: `
    ...
    .input { padding: 12px 14px; font-size: 15px; border: 1px solid #e4e4e7; border-radius: 8px; background-color: #ffffff; }
    .result-card { background-color: #eef2ff; border: 1px solid #c7d2fe; border-radius: 12px; padding: 16px; align-items: center; }
    .greeting { font-size: 18px; font-weight: 600; color: #4338ca; }
  `,
