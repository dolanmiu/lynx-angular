...
@Component({
  ...
  styles: `
    ...
    .card { background-color: #ffffff; border: 1px solid #e4e4e7; border-radius: 12px; padding: 16px; overflow: hidden; }
    ...
    .list { height: 300px; }
    .list-row { padding: 12px 0; border-bottom: 1px solid #e4e4e7; flex-direction: row; align-items: center; }
    .list-avatar { width: 32px; height: 32px; border-radius: 16px; background-color: #eef2ff; align-items: center; justify-content: center; }
    .list-avatar-text { font-size: 12px; font-weight: 600; color: #6366f1; }
    .list-item-text { font-size: 15px; color: #18181b; }
  `,
