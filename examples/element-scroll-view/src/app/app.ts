...
@Component({
  ...
  styles: `
    ...
    .scroll-area { height: 300px; border: 1px solid #e4e4e7; border-radius: 8px; }
    .scroll-item { padding: 14px 16px; border-bottom: 1px solid #e4e4e7; }
    .scroll-item-text { font-size: 15px; color: #18181b; }
  `,
