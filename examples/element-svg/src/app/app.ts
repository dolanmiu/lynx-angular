...
@Component({
  ...
  styles: `
    ...
    .svg-frame { background-color: #f4f4f5; border-radius: 8px; padding: 20px; align-items: center; margin-bottom: 12px; }
    .svg-icon { width: 100px; height: 100px; }
    .info { font-size: 13px; color: #71717a; line-height: 18px; }
  `,
