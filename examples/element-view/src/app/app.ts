...
@Component({
  ...
  styles: `
    ...
    .demo-card { background-color: #f4f4f5; border-radius: 10px; padding: 16px; }
    .row { flex-direction: row; align-items: center; }
    .avatar { width: 40px; height: 40px; border-radius: 20px; background-color: #6366f1; align-items: center; justify-content: center; }
    .avatar-text { color: white; font-weight: bold; font-size: 16px; }
    .info { margin-left: 12px; flex: 1; }
    .card-title { font-size: 16px; font-weight: 600; color: #18181b; margin-bottom: 4px; }
    .card-desc { font-size: 13px; color: #71717a; line-height: 18px; }
  `,
