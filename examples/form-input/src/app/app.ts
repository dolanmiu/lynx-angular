...
@Component({
  ...
  styles: `
    ...
    .label { font-size: 14px; font-weight: bold; color: #4a5568; margin-bottom: 4px; margin-top: 16px; }
    .input { padding: 12px; font-size: 16px; background-color: white; border-radius: 8px; border: 2px solid #e2e8f0; }
    .input-focused { border-color: #4299e1; }
    .input-error { border-color: #fc8181; }
    .textarea { padding: 12px; font-size: 16px; background-color: white; border-radius: 8px; border: 2px solid #e2e8f0; height: 100px; }
    .char-count { font-size: 12px; color: #a0aec0; text-align: right; margin-top: 4px; }
    .error { font-size: 13px; color: #e53e3e; margin-top: 4px; }
    .submit-button { background-color: #4299e1; border-radius: 8px; padding: 14px; align-items: center; margin-top: 24px; }
    .submit-text { color: white; font-size: 16px; font-weight: bold; }
    .success { font-size: 16px; color: #38a169; text-align: center; margin-top: 16px; }
  `,
})
export class App {
