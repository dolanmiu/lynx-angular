...
@Component({
  ...
  template: `
    <scroll-view class="page" scroll-orientation="vertical">
      <view class="container">
        ...
        <text class="subtitle">Internationalization with Angular and Lynx.</text>
        ...
        <view class="card">
          ...
          <text i18n="@@app.greeting" class="greeting">
            Hello, world!
          </text>
          <text class="welcome">{{ welcomeMessage }}</text>
          <text
            i18n="app description|A brief description of the i18n example@@app.description"
            class="description"
          >
  ...
  styles: `
    ...
    .locale-badge { background-color: #eef2ff; padding: 10px 14px; border-radius: 8px; margin-bottom: 16px; }
    .locale-text { font-size: 13px; font-weight: 600; color: #4338ca; }
    ...
    .greeting { font-size: 18px; color: #18181b; margin-bottom: 8px; }
    .welcome { font-size: 15px; color: #18181b; margin-bottom: 8px; }
    .description { font-size: 13px; color: #71717a; }
    .counter { font-size: 18px; color: #18181b; margin-bottom: 12px; }
