...
export const ICONS = {
  ...
  'share-2': svg(
    '<circle cx="18" cy="5" r="3" /> <circle cx="6" cy="12" r="3" /> <circle cx="18" cy="19" r="3" /> <path d="M8.59 13.51 L15.42 17.49"/> <path d="M15.41 6.51 L8.59 10.49"/>',
  ),
  ...
  'zoom-in': svg(
    '<circle cx="11" cy="11" r="8" /> <path d="M21 21 L16.65 16.65"/> <path d="M11 8 L11 14"/> <path d="M8 11 L14 11"/>',
  ),
  'zoom-out': svg(
    '<circle cx="11" cy="11" r="8" /> <path d="M21 21 L16.65 16.65"/> <path d="M8 11 L14 11"/>',
  ),
  scissors: svg(
  ...
  'volume-x': svg(
    '<path d="M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z" /> <path d="M22 9 L16 15"/> <path d="M16 9 L22 15"/>',
  ),
  mic: svg(
  ...
  'phone-call': svg(
    '<path d="M13 2a9 9 0 0 1 9 9" /> <path d="M13 6a5 5 0 0 1 5 5" /> <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233a14 14 0 0 0 6.392 6.384" />',
  ),
  'at-sign': svg(
    '<circle cx="12" cy="12" r="4" /> <path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8" />',
  ),
  inbox: svg(
    '<path d="M22 12 L16 12 L14 15 L10 15 L8 12 L2 12"/> <path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" />',
  ),
  megaphone: svg(
  ...
  'hard-drive': svg(
    '<circle cx="10" cy="16" r="1" fill="currentColor" stroke="none"/> <path d="M2.212 11.577a2 2 0 0 0-.212.896V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.527a2 2 0 0 0-.212-.896L18.55 5.11A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /> <path d="M21.946 12.013H2.054" /> <circle cx="6" cy="16" r="1" fill="currentColor" stroke="none"/>',
  ),
  // Status & Alerts
  'check-circle': svg(
  ...
  'alert-circle': svg(
    '<circle cx="12" cy="12" r="10" /> <path d="M12 8 L12 12"/> <path d="M12 16 L12.01 16"/>',
  ),
  'plus-circle': svg(
  ...
  'user-plus': svg(
    '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /> <circle cx="9" cy="7" r="4" /> <path d="M19 8 L19 14"/> <path d="M22 11 L16 11"/>',
  ),
  'user-check': svg(
    '<path d="m16 11 2 2 4-4" /> <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /> <circle cx="9" cy="7" r="4" />',
  ),
  'user-x': svg(
    '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /> <circle cx="9" cy="7" r="4" /> <path d="M17 8 L22 13"/> <path d="M22 8 L17 13"/>',
  ),
  'thumbs-up': svg(
  ...
  smile: svg(
    '<circle cx="12" cy="12" r="10" /> <path d="M8 14s1.5 2 4 2 4-2 4-2" /> <path d="M9 9 L9.01 9"/> <path d="M15 9 L15.01 9"/>',
  ),
  frown: svg(
    '<circle cx="12" cy="12" r="10" /> <path d="M16 16s-1.5-2-4-2-4 2-4 2" /> <path d="M9 9 L9.01 9"/> <path d="M15 9 L15.01 9"/>',
  ),
  hand: svg(
  ...
  'credit-card': svg(
    '<rect width="20" height="14" x="2" y="5" rx="2" /> <path d="M2 10 L22 10"/>',
  ),
  'dollar-sign': svg(
    '<path d="M12 2 L12 22"/> <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />',
  ),
  tag: svg(
  ...
  package: svg(
    '<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z" /> <path d="M12 22V12" /> <path d="M3.29 7 L12 12 L20.71 7"/> <path d="m7.5 4.27 9 5.15" />',
  ),
  truck: svg(
  ...
  'cloud-snow': svg(
    '<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /> <circle cx="8" cy="15" r="1" fill="currentColor" stroke="none"/> <circle cx="8" cy="19" r="1" fill="currentColor" stroke="none"/> <circle cx="12" cy="17" r="1" fill="currentColor" stroke="none"/> <circle cx="12" cy="21" r="1" fill="currentColor" stroke="none"/> <circle cx="16" cy="15" r="1" fill="currentColor" stroke="none"/> <circle cx="16" cy="19" r="1" fill="currentColor" stroke="none"/>',
  ),
  wind: svg(
  ...
  wifi: svg(
    '<circle cx="12" cy="20" r="1" fill="currentColor" stroke="none"/> <path d="M2 8.82a15 15 0 0 1 20 0" /> <path d="M5 12.859a10 10 0 0 1 14 0" /> <path d="M8.5 16.429a5 5 0 0 1 7 0" />',
  ),
  ...
  smartphone: svg(
    '<rect width="14" height="20" x="5" y="2" rx="2" ry="2" /> <circle cx="12" cy="18" r="1" fill="currentColor" stroke="none"/>',
  ),
  monitor: svg(
    '<rect width="20" height="14" x="2" y="3" rx="2" /> <path d="M8 21 L16 21"/> <path d="M12 17 L12 21"/>',
  ),
  laptop: svg(
  ...
  server: svg(
    '<rect width="20" height="8" x="2" y="2" rx="2" ry="2" /> <rect width="20" height="8" x="2" y="14" rx="2" ry="2" /> <path d="M6 6 L6.01 6"/> <path d="M6 18 L6.01 18"/>',
  ),
  cpu: svg(
  ...
  list: svg(
    '<circle cx="3" cy="5" r="1" fill="currentColor" stroke="none"/> <circle cx="3" cy="12" r="1" fill="currentColor" stroke="none"/> <circle cx="3" cy="19" r="1" fill="currentColor" stroke="none"/> <path d="M8 5h13" /> <path d="M8 12h13" /> <path d="M8 19h13" />',
  ),
  'list-checks': svg(
