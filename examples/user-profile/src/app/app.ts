...
@Component({
  ...
  template: `
    <scroll-view scroll-orientation="vertical" class="page">
      <view class="container">
        ...
        <ui-button class="w-full" (pressed)="editOpen.set(true)">Edit Profile</ui-button>
    ...
    <ui-sheet [(open)]="editOpen">
      ...
      <ui-sheet-footer>
        <ui-button variant="outline" (pressed)="editOpen.set(false)">Cancel</ui-button>
  ...
  styles: `
    ...
    .container { display: flex; flex-direction: column; align-items: center; gap: 20px; padding: 32px 24px; }
    .profile-header { display: flex; flex-direction: column; align-items: center; gap: 8px; }
    .name { font-size: 24px; font-weight: bold; color: #18181b; }
    .username-row { display: flex; flex-direction: row; align-items: center; gap: 8px; }
    .username { font-size: 14px; color: #71717a; }
    .stats-row { display: flex; flex-direction: row; gap: 28px; padding: 20px 24px; background-color: #ffffff; border: 1px solid #e4e4e7; border-radius: 16px; }
    .stat { display: flex; flex-direction: column; align-items: center; gap: 2px; }
    .stat-value { font-size: 20px; font-weight: bold; color: #18181b; }
    .stat-label { font-size: 12px; color: #a1a1aa; }
    .bio-text { font-size: 14px; color: #71717a; line-height: 20px; }
