...
import { ElementsShowcase } from './elements-showcase';

describe('ElementsShowcase', () => {
  it('renders the showcase title', async () => {
    const { getByText } = await render(ElementsShowcase);
  ...
  it('tapping the Tap Me button increments tapCount', async () => {
    const { componentRef, getByText } = await render(ElementsShowcase);
    const instance = componentRef.instance as ElementsShowcase;
  ...
  it('handleTap() increments tapCount multiple times', async () => {
    const { componentRef } = await render(ElementsShowcase);
    const instance = componentRef.instance as ElementsShowcase;
