...
import { OverlayMotionDemoComponent } from './overlay-motion-demo.component';

describe('OverlayMotionDemoComponent', () => {
  ...
  it('renders Open Dialog button', async () => {
    const { getByText } = await render(OverlayMotionDemoComponent);
  ...
  it('starts with overlayVisible false', async () => {
    const { componentRef } = await render(OverlayMotionDemoComponent);
    const instance = componentRef.instance as OverlayMotionDemoComponent;
