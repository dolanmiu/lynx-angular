...
import { QuerySelectorDemoComponent } from './query-selector-demo.component';

describe('QuerySelectorDemoComponent', () => {
  it('renders the page title', async () => {
    const { getByText } = await render(QuerySelectorDemoComponent);
  ...
  it('qsActive is resolved after view init (class selector works)', async () => {
    const { componentRef } = await render(QuerySelectorDemoComponent);
    const instance = componentRef.instance as QuerySelectorDemoComponent;
