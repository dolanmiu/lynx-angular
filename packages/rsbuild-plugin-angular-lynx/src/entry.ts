        ...
        .use(LynxTemplatePlugin, [
          {
            ...
            targetSdkVersion,
            enableA11y: true,
            // experimental_isLazyBundle controls whether the ROOT app is a
            // standalone lazy bundle (appType: DynamicComponent). For a normal
            // card app with lazy routes, the root must remain card type — only
            // async sub-bundles generated by LynxTemplatePlugin's
            // #generateAsyncTemplate() should be DynamicComponent.
          },
        ])
        .end();
    }
        ...
        .use(RuntimeWrapperWebpackPlugin, [
          {
            ...
            // Async chunks MUST be AMD-wrapped — lynx.requireModuleAsync requires it.
