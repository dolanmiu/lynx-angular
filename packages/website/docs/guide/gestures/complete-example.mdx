...
A full component combining tap, long-press, and pan gestures with `Gesture.Exclusive()` composition. Tap increments a counter, long-press resets it, and pan tracks finger position.
